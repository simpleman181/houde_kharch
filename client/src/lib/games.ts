...
export const games: Game[] = [
  ...
  {
    id: 'gudi-padwa',
    titleMarathi: 'गुडी पाडवा',
    titleEnglish: 'Gudi Padwa',
    description: 'मराठी नववर्षाचा सण - गुडी उभारा',
    emoji: '🚩',
    color: 'from-amber-500 to-orange-600',
    category: 'education',
    path: '/gudi-padwa',
  ...
  {
    id: 'janmashtami',
    titleMarathi: 'जन्माष्टमी - दही हंडी',
    titleEnglish: 'Janmashtami Dahi Handi',
    description: 'कृष्णाचा जन्मदिन साजरा करा - दही हंडी फोडा',
    emoji: '🏺',
  ...
  {
    id: 'makar-sankranti',
    titleMarathi: 'मकर संक्रांत',
    titleEnglish: 'Makar Sankranti',
    description: 'आकाशात पतंग उडवा',
    emoji: '🪁',
  ...
  {
    id: 'nag-panchami',
    titleMarathi: 'नाग पंचमी',
    titleEnglish: 'Nag Panchami',
    description: 'सर्प देवताला पूजा करा',
    emoji: '🐍',
    color: 'from-green-500 to-emerald-600',
    category: 'education',
    path: '/nag-panchami',
  ...
  {
    id: 'narali-pournima',
    titleMarathi: 'नारळी पौर्णिमा',
    titleEnglish: 'Narali Pournima',
    description: 'समुद्रदेवाला नारळ अर्पित करा',
    emoji: '🥥',
